...
{
    self.takenImage = [self fixOrientation:self.takenImage];
    ...
    UIImage *image = [UIImage imageWithCGImage:cropped.CGImage scale:1.0 orientation:self.takenImage.imageOrientation];
    return image;
}
